...
urlpatterns = [
    ...
    path('delete_notes/<int:pk>',views.delete_note,name="delete-note"), #mapping views.delete_note function
    path('notes_detail/<int:pk>',views.NotesDetailView.as_view(),name="notes-detail"), #mapping views.notes_detail function
    
    path('homework',views.homework, name="homework"),
    path('update_homework/<int:pk>',views.update_homework,name="update-homework"), #pk primary key
